...
See @fig-obraz2 for an illustration

[Skocz do koniec](#koniec)
...
Trzeci itd.. You can also do this on a per-format basis (if for example you want to provide a higher resolution image for EPUB and a lower resolution image for HTML to reduce download time). For example:
...
::: {layout-ncol="2"}
![Właściwy opis wykresu](graph1.png){#fig-obraz1 .lightbox width="300"}

![Właściwy opis wykresu](graph2.png){#fig-obraz2 .lightbox width="300"}
:::
...
::: {#fig-elephant}
<iframe width="560" height="315" src="https://www.youtube.com/watch?v=kZa7SOD5t8o">
